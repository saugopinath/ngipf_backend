...
[Keyless]
[Table("hr_md_gen_ndo_emp_map_wf", Schema = "ihrms_master")]
public partial class HrMdGenNdoEmpMapWf
{
    [Column("ACTIVE_FLAG")]
    [StringLength(2)]
    ...
    [Column("TAG_FROM_DT")]
    public DateOnly TagFromDt { get; set; }

    [Column("TAG_TO_DT")]
    public DateOnly? TagToDt { get; set; }
