...
[Table("hr_md_emp_relationship", Schema = "ihrms_emp_master")]
public partial class HrMdEmpRelationship
{
    ...
    [InverseProperty("IntEmpRelationship")]
    public virtual ICollection<HrMdEmpNomineeDtl> HrMdEmpNomineeDtls { get; set; } = new List<HrMdEmpNomineeDtl>();

    [ForeignKey("IntRelMaritialStatus")]
    [InverseProperty("HrMdEmpRelationshipIntRelMaritialStatusNavigations")]
    public virtual HrMmGenOtherMaster? IntRelMaritialStatusNavigation { get; set; }

    [ForeignKey("RelIntOmiRelationship")]
    [InverseProperty("HrMdEmpRelationshipRelIntOmiRelationshipNavigations")]
    public virtual HrMmGenOtherMaster? RelIntOmiRelationshipNavigation { get; set; }

    [ForeignKey("RequestId")]
    [InverseProperty("HrMdEmpRelationships")]
