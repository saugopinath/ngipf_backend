...
[Keyless]
[Table("hr_md_gen_hoo_group_wf", Schema = "ihrms_master")]
public partial class HrMdGenHooGroupWf
{
    [Column("GROUP_NAME")]
    [StringLength(200)]
    ...
    [Column("INT_HR_MD_GEN_GROUP_WF_old")]
    [StringLength(38)]
    public string? IntHrMdGenGroupWfOld { get; set; }

    [Column("INT_HR_MD_GEN_GROUP_WF")]
    public int? IntHrMdGenGroupWf { get; set; }
