...
[Table("hr_md_emp_deduction_wf", Schema = "ihrms")]
[Index("IntEmployeeId", Name = "ind_hr_md_emp_deduction_wf1")]
[Index("IntCompId", Name = "ind_hr_md_emp_deduction_wf2")]
[Index("RequestId", Name = "ind_hr_md_emp_deduction_wf3")]
public partial class HrMdEmpDeductionWf
{
    [Key]
    [Column("int_emp_deduction_id_wf")]
    [StringLength(38)]
    public string IntEmpDeductionIdWf { get; set; } = null!;
