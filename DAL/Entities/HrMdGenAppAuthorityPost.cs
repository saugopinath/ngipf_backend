...
[Keyless]
[Table("hr_md_gen_app_authority_post", Schema = "ihrms_master")]
public partial class HrMdGenAppAuthorityPost
{
    [Column("ACTIVE_FLAG")]
    [StringLength(1)]
    ...
    [Column("INT_APP_AUTHORITY_POST_ID_old")]
    [StringLength(38)]
    public string? IntAppAuthorityPostIdOld { get; set; }

    [Column("INT_APP_AUTHORITY_POST_ID")]
    public int? IntAppAuthorityPostId { get; set; }
