...
[Keyless]
[Table("hr_md_gen_aa_personal_address", Schema = "ihrms_master")]
public partial class HrMdGenAaPersonalAddress
{
    ...
    [Column("INT_APPT_AUTH_ID_old")]
    [StringLength(38)]
    public string? IntApptAuthIdOld { get; set; }

    [Column("INT_APPT_AUTH_ID")]
    public int? IntApptAuthId { get; set; }
