...
[Table("hr_md_emp_out_of_act_ded", Schema = "ihrms")]
[Index("IntEmployeeId", Name = "ind_hr_md_emp_out_of_act_ded")]
[Index("IntCompId", Name = "ind_hr_md_emp_out_of_act_ded1")]
[Index("RequestId", Name = "ind_hr_md_emp_out_of_act_ded2")]
[Index("IntOadSocietyBankId", Name = "ind_hr_md_emp_out_of_act_ded5")]
public partial class HrMdEmpOutOfActDed
{
    [Key]
    [Column("int_out_of_act_ded_id")]
    [StringLength(38)]
    public string IntOutOfActDedId { get; set; } = null!;
