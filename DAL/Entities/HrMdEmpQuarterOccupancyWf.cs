...
[Table("hr_md_emp_quarter_occupancy_wf", Schema = "ihrms")]
[Index("StateId", Name = "ind_hr_md_emp_quarter_occ_wf1")]
[Index("IntEmployeeId", Name = "ind_hr_md_emp_quarter_occu_wf1")]
[Index("IntDistrictId", Name = "ind_hr_md_emp_quarter_occu_wf2")]
[Index("IntResidentialTypeId", Name = "ind_hr_md_emp_quarter_occu_wf3")]
[Index("IntOmiQuarterTypeId", Name = "ind_hr_md_emp_quarter_occu_wf4")]
public partial class HrMdEmpQuarterOccupancyWf
{
    [Key]
    [Column("int_qua_occu_id_wf")]
    [StringLength(38)]
    public string IntQuaOccuIdWf { get; set; } = null!;
