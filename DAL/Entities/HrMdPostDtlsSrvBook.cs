...
[Table("hr_md_post_dtls_srv_book", Schema = "ihrms_emp_master")]
public partial class HrMdPostDtlsSrvBook
{
    [Column("parent_flag")]
    [StringLength(1)]
    ...
    [Column("hrms_hoo_flag")]
    [StringLength(2)]
    public string? HrmsHooFlag { get; set; }

    [Column("hoo_manual_desc")]
    [StringLength(100)]
    public string? HooManualDesc { get; set; }
    ...
    [Column("prev_int_post_dtls_srv_book_old")]
    [StringLength(38)]
    public string? PrevIntPostDtlsSrvBookOld { get; set; }

    [Column("prev_int_post_dtls_srv_book")]
    public int? PrevIntPostDtlsSrvBook { get; set; }

    [Key]
    [Column("int_post_dtls_srv_book")]
    public int IntPostDtlsSrvBook { get; set; }

    [InverseProperty("IntPostDtlsSrvBookNavigation")]
