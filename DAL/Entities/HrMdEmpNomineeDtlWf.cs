...
[Table("hr_md_emp_nominee_dtl_wf", Schema = "ihrms_emp_master")]
public partial class HrMdEmpNomineeDtlWf
{
    [Column("nominee_name")]
    [StringLength(200)]
    ...
    [Column("int_nom_id_wf_old")]
    [StringLength(38)]
    public string? IntNomIdWfOld { get; set; }
    ...
    [Key]
    [Column("int_nom_id_wf")]
    public int IntNomIdWf { get; set; }

    [ForeignKey("IntEmployeeId")]
    [InverseProperty("HrMdEmpNomineeDtlWfs")]
    public virtual HrMmEmpBasicDtl? IntEmployee { get; set; }

    [ForeignKey("IntMaritalStatusId")]
    [InverseProperty("HrMdEmpNomineeDtlWfIntMaritalStatuses")]
    public virtual HrMmGenOtherMaster? IntMaritalStatus { get; set; }

    [ForeignKey("NomIntOmiPhysicChallenged")]
    [InverseProperty("HrMdEmpNomineeDtlWfNomIntOmiPhysicChallengedNavigations")]
    public virtual HrMmGenOtherMaster? NomIntOmiPhysicChallengedNavigation { get; set; }
}
