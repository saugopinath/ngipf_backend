...
[Keyless]
[Table("hr_md_gen_ho_group_address_wf", Schema = "ihrms_master")]
public partial class HrMdGenHoGroupAddressWf
{
    ...
    [Column("INT_HO_GRP_ADDRESS_ID_WF_old")]
    [StringLength(38)]
    public string? IntHoGrpAddressIdWfOld { get; set; }

    [Column("INT_HO_GRP_ADDRESS_ID_WF")]
    public int? IntHoGrpAddressIdWf { get; set; }
