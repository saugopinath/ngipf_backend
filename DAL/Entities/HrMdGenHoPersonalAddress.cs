...
[Keyless]
[Table("hr_md_gen_ho_personal_address", Schema = "ihrms_master")]
public partial class HrMdGenHoPersonalAddress
{
    ...
    [Column("INT_HO_PERSONAL_ADDRESS_ID_old")]
    [StringLength(38)]
    public string? IntHoPersonalAddressIdOld { get; set; }

    [Column("INT_HO_PERSONAL_ADDRESS_ID")]
    public int? IntHoPersonalAddressId { get; set; }
